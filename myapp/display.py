...
margin-left: 25%;
margin-top: 2%;">
                <strong>Recent URLs retrieved successfully</strong>
    ...
    <script>
                    Swal.fire(
                    'Most recent URLs from Cloudant Database',
                    'Loaded successfully!',
                    'success'
                             )
    ...
    <div class="container-fluid">
      ...
      <footer class="page-footer font-small blue fixed-bottom">
        ...
        <div class="footer-copyright text-center py-3"
          ...
          <span>© 2020 Copyright: Abhishek Saxena&nbsp;&nbsp;
            <a class="ins-ic" href="https://github.com/abhisheksaxena1998"><i class="fab fa-github  fa-2x"></i></a></span>
